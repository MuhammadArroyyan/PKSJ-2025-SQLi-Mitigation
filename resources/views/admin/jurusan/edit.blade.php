    ...
    <div class="card">
        <form action="{{ route('admin.jurusan.update', $jurusan->id_jurusan) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_jurusan" name="nama_jurusan" required value="{{ old('nama_jurusan', $jurusan->nama_jurusan) }}">
                @error('nama_jurusan')
            ...
            <div class="form-group">
                ...
                <select id="id_fakultas" name="id_fakultas" required>
                    ...
                    @foreach($fakultas as $f)
                        <option value="{{ $f->id_fakultas }}" {{ old('id_fakultas', $jurusan->id_fakultas) == $f->id_fakultas ? 'selected' : '' }}>
                            {{ $f->nama_fakultas }}
                        </option>
                    @endforeach
                </select>
